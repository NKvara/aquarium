  ...
  return (
    ...
    >
      ...
      <video
        ...
        playsInline
      />
      <div className="flex gap-8 z-10 pc:max-w-pc w-full p-6 backdrop-blur-lg overflow-hidden">
        <iframe
        ...
        <div className="w-1/2 flex flex-col gap-4 text-neutral-100">
          ...
          <button className="mt-12 bg-neutral-100 hover:bg-neutral-200 transition cursor-pointer text-lg py-2 w-full text-black rounded-sm">
            Send
          </button>
        </div>
      </div>
