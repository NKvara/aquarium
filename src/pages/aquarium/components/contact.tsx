...
const Contact = () => {
  return (
    <Element
      name="contact"
      className="flex justify-center items-center w-svw h-svh bg-cover p-2"
    ...
    >
      ...
      <video
        ...
        playsInline
      />
      <div className="flex flex-col pc:flex-row gap-8 z-10 pc:max-w-pc w-full p-6 backdrop-blur-lg">
        <iframe
          ...
          className="h-72 pc:h-auto pc:w-1/2"
        />
        <div className="pc:w-1/2 flex flex-col gap-4 text-neutral-100">
          <h1 className="font-title text-4xl pc:text-5xl mb-2 pc:mb-4">Contact Us</h1>
          <Input label="Name" />
          <Input label="Email" />
